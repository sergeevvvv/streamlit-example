...
text = st.text_input('Введите формулу словами', value="интеграл икс от икс до икс по дэ икс")
...
st.text('Баги и идеи на github: https://github.com/sergeevvvv/MathMT/issues')
